...
describe('API routes', () => {
  ...
  describe('GET', ()=>{
    ...
    describe('api/v1/ingredients/:id', () => {
      it('should get a specific ingredient', () => chai
        .request(server)
      ...
      it('should return 404 if ingredient with requested id does not exist', () => chai
        .request(server)
    ...
    describe('api/v1/recipes', () => {
      ...
      it('should return all the recipes', () => chai
        .request(server)
        .get('/api/v1/recipes')
        .then((response) => {
    ...
    describe('api/v1/recipes/:id', () => {
      it('should get a specific recipe', () => chai
        .request(server)
      ...
      it('should return 404 if remark with requested id does not exist', () => chai
        .request(server)
